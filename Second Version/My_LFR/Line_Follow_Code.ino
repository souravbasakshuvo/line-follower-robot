    ...
    if (sum == 0) {
      ...
      if (sensor == 0b001100) {
        ...
        if (pos != 0) {
          ...
          delay(10); pos = 0;  
          //this logic is for those whose bot is wabbling during high speed run. this logic will forcefully return bot to its midpoint. 
          //don't give more than 30ms delay here!
        }
        motor(10 * spr, 10 * spl);
      }
      ...
      if (sum == 6) { //Stop Point Detection
        motor(0, 0);
        while (sum == 6) reading_black();
        delay(1000);
      }
    }
    else if (sensor == 0b110011 || sensor == 0b110111 || sensor == 0b111011)line_follow_white();
  }
}
...
void line_follow_white(){
  while(1){
    ...
    if (sum == 0) {
      ...
      if (sum == 6) { //Stop Point Detection
        motor(0, 0);
        while (sum == 6) reading_white();
        delay(1000);
      }
    }
    else if (sensor == 0b110011 || sensor == 0b110111 || sensor == 0b111011)line_follow_black();
  }
}
